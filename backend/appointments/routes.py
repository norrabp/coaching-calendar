...
from backend.appointments.request_models import CreateAppointmentRequest, GetAvailableSlotsRequest, GetMyAppointmentsRequest, GetOpenAppointmentsRequest, UpdateAppointmentRequest
from backend.appointments.domain import create_appointment, get_available_timeslots, update_appointment
...
def get_open_appointments_api():
    ...
    appointments, has_next_page = get_open_appointments_query(data.pagination_info, start_time_inclusive=data.start_time, coach_id=data.coach_id)
